        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#activities" className="hover:text-primary transition-colors">Daily Activities</a></li>
              <li><a href="#testimonials" className="hover:text-primary transition-colors">Family Testimonials</a></li>
